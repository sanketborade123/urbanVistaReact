        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-5 ml-4 mt-2'>
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-slate-700 rounded-lg uppercase text-white hover:opacity-80 cursor-pointer disabled:opacity-80 mt-4'>{loading ? 'Updating..' : 'Update Listing'}</button>
